...
if (route.data.version !== 'sonya-v14-telegram-no-panel-buttons') throw new Error('Wrong route-check version');
...
if (overview.data.overview.bindings.files !== 'metadata_only') throw new Error('File storage must be metadata_only in v14');
...
console.log('SMOKE OK: v14 clean Telegram replies paths passed');
